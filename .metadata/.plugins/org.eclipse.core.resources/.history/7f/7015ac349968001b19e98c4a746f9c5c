...
angular.module('cotizador',['ngRoute','ngResource'])
  ...
  .config(['$routeProvider', function($routeProvider) {
    $routeProvider
      ...
      .when('/DatosAsegurados',{templateUrl:'views/DatosAsegurado/detail.html',controller:'EditDatosAseguradoController'})
      ...
      .when('/Valorizacions/new',{templateUrl:'views/Valorizacion/detail.html',controller:'NewValorizacionController'})
